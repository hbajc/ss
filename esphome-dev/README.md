...
这个插件允许您编写配置，并通过 Home Assistant 直接将您的微控制器转变为智能家居设备，**无需编程经验**。您只需要编写 YAML 配置文件；其他（无线更新、编译）都由 ESPHome 处理。

<p align="center">
<img title="ESPHome 设备构建器屏幕截图" src="https://github.com/esphome/home-assistant-addon/raw/main/esphome-dev/images/screenshot.png" width="700px"></img>
</p>
...
使用 ESPHome，您可以将几行 YAML 直接转化为定制的固件。例如，要包含一个 [DHT22][dht22] 温湿度传感器，您只需在配置文件中添加 8 行 YAML：
...
然后只需点击上传，传感器即可神奇地出现在 Home Assistant 中：
