...
⚠️ 该项目正在积极开发中。可能会遇到错误和变化。请不要将其作为存储照片和视频的唯一方式！ （来自开发者）
...
请注意，你需要安装一个单独的 postgres 插件来连接数据库。你可以在我的库中已经安装 postgres 插件。
请注意在启动之前更改密码；启动后将无法更改

## 支持

在 GitHub 上创建一个问题，或在 [Home Assistant 论坛](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 上提问
