# Home assistant 添加插件：immich

⚠️ 此项目正在积极开发中。可能会有错误和变化。请勿将其作为存储您照片和视频的唯一方式！（来自开发者）
...
_感谢每一个给我的仓库加星的人！要加星请点击下面的图片，然后它会在右上角。谢谢！_

[![星标者 @alexbelgium/hassio-addons 的仓库](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg)](https://github.com/alexbelgium/hassio-addons/stargazers)
...
此插件的安装相对简单，与安装其他 Hass.io 插件没有不同。
...
1. 启动插件。
1. 检查插件的日志以查看是否一切正常。
1. 根据您的偏好小心地配置插件，具体请参见官方文档。

请注意，您需要安装一个单独的 postgres 插件以便能够连接数据库。您可以在我的仓库中已经安装 postgres 插件。
请务必在启动之前更改密码； 否则，之后将无法更改。

## 支持

在 GitHub 上创建一个问题，或在 [家居助手讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 上询问。
