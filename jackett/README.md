...
_感谢所有给我的仓库加星的人！要给它加星，请点击下方的图像，然后它会在右上角。谢谢！_
...
[jackett](https://github.com/jackett/jackett) - 一个 fork 的 jackett，旨在处理像 Couchpotato 这样的电影。

该插件基于来自 linuxserver.io 的 [docker 镜像](https://github.com/linuxserver/docker-jackett)。

## 配置

配置可以通过应用程序的 WebUI 进行，除以下选项外：
