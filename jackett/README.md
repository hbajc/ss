...
_感谢每一个给我的仓库加星的人！要加星，请点击下方的图片，然后它会在右上角显示。谢谢！_
...
[jackett](https://github.com/jackett/jackett) - jackett 的一个分支，适用于像 Couchpotato 这样的电影。
...
GPID: 用户
TZ: 时区
localdisks: sda1 # 输入驱动器的硬件名称（以逗号分隔），或其标签。例如 sda1, sdb1, MYNAS...
