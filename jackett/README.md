...
_感谢所有为我的代码库加星的人！要加星请点击下面的图像，然后它将出现在右上角。谢谢！_
...
[jackett](https://github.com/jackett/jackett) - 一个 fork 版本的 jackett，可以处理像 Couchpotato 这样的电影。

此插件基于来自 linuxserver.io 的 [docker 镜像](https://github.com/linuxserver/docker-jackett)。

## 配置

配置可以通过应用的 Web UI 完成，但以下选项除外：
