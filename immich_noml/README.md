...
⚠️ 该项目正在积极开发中。请预期会有bug和更改。请不要将其作为存储照片和视频的唯一方式！（开发者说明）
...
_感谢所有给我的仓库加星的人！要给我的仓库加星，请点击下面的图片，然后会在右上角显示。谢谢！_
...
安装此插件非常简单，与安装任何其他Hass.io插件没有什么不同。
...
在github上创建一个问题，或者在[Home Assistant 论坛](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3)上提问。
