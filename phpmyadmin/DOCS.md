...
该插件专为管理官方 Home Assistant MariaDB 插件而设计。
...
`log_level` 选项控制插件的日志输出级别，并可以更改为更详细或较少详细，这在处理未知问题时可能很有用。可能的值有：
...
- 该插件旨在管理官方 Home Assistant MariaDB 插件。它无法连接到其他 MySQL 或 MariaDB 服务器。

## 更新日志与发布

本代码库使用 [GitHub 的发布][releases] 功能维护变更日志。
